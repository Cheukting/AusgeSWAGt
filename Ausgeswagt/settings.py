"""
Django settings for Ausgeswagt project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-k$=kdgo%oa4acl6i7)pus9-clnq8a$ijrh46fgpzpwoaloz4r%')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,ausgeswagt-kpu78.ondigitalocean.app,ausgeswagt.cheuk.dev').split(',')
...
WSGI_APPLICATION = 'Ausgeswagt.wsgi.application'
